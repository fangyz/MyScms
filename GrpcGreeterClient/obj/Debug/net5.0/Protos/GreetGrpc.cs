...
namespace GrpcGreeterClient {
  ...
  /// </summary>
  public static partial class GreeterClientTest
  {
    static readonly string __ServiceName = "greet.GreeterClientTest";
    ...
    /// <summary>Client for GreeterClientTest</summary>
    public partial class GreeterClientTestClient : grpc::ClientBase<GreeterClientTestClient>
    {
      /// <summary>Creates a new client for GreeterClientTest</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GreeterClientTestClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for GreeterClientTest that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GreeterClientTestClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GreeterClientTestClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GreeterClientTestClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected override GreeterClientTestClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new GreeterClientTestClient(configuration);
      }
    }
